...
| 项 | 版本 |
|---|---|
| 模板 `template_version`（权威） | 1.4.2.patch0 |
| `../SKILL.md` `metadata.version` | 1.4.2.patch0 |
| 上次核对模板版本 | 1.4.2.patch0 |
...
| 模板红线 | 主题 | 精简版条目 | 处理 | 指纹 |
|---|---|---|---|---|
| 红线 1 | 要求三要素（意图/展示/验收） | SKILL 规范 1 | 原样 | bbd3023e05df |
| 红线 2 | 先对齐后实施 | SKILL 规范 2 | 原样 | 55fb2ba46ee4 |
| 红线 3 | 变更分级 | SKILL 规范 3 | 原样 | 855b6bd7d44f |
| 红线 4 | 实施后自动审计 | SKILL 规范 4 | 原样 | b0aba1a12650 |
| 红线 5 | 删除纪律 | SKILL 规范 5 | 通用化 | ee28329cc7e5 |
| 红线 6 | 回读校验 | SKILL 规范 6 | 原样 | 8c1152fba4da |
| 红线 7 | 创建前相似检查 | SKILL 规范 7 | 原样 | 1cbeaaa75633 |
| 红线 8 | 信息以用户/事实为准 | SKILL 规范 8 | 原样 | 6484ccc76d68 |
| 红线 9 | 不破坏用户未提交的改动 | SKILL 规范 9 | 原样 | cbdd02ed2b0a |
| 红线 10 | private 目录纪律 | SKILL 规范 10 | 通用化 | 8666e79b114a |
| 红线 11 | 发布前验证 | SKILL 规范 11 | 通用化 | ed98f8b269a8 |
| 红线 12 | 密钥安全 | SKILL 规范 10 | 通用化 | f888e9170915 |
| 红线 13 | 文档同步与治理 | SKILL 规范 12 | 原样 | f691f0b47603 |
| 红线 14 | 立项调研先行 | SKILL 规范 13 | 原样 | ccc5f372d29d |
| 红线 15 | 阶段落盘 | SKILL 规范 14 | 通用化 | 5e5845856413 |
| 红线 16 | 上下文恢复重读 | SKILL 规范 15 | 原样 | 054844de3d36 |
| 红线 17 | 范围克制与纠错清零 | SKILL 规范 17 | 原样 | 9ce0c0bcd194 |
| 红线 18 | 提问与共识确认（共识卡/重检行） | SKILL 规范 18 | 原样 | cd4ffccd0713 |
| 红线 19 | 敏感信息与私有区边界 | SKILL 规范 10 | 通用化 | 5e50671be3c6 |
