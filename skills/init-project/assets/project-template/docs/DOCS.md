...
- **动机**：文档质量不能只靠写的人自觉——换个 agent、开个新对话，若读不到标准、
  没东西拦着，质量就会滑下去。把标准写明、给例子、加评审，把下限抬起来。

**四条标准**：

1. **严谨但不失通俗**：内容准确可靠，但说得让人看得懂。不为严谨弄得含糊，
   也不为通俗牺牲准确；专业内容要用外行能懂的话讲清。
2. **反 AI 感**：去掉机器腔与套话，写得像人话。写完读一遍，读着像机器写的
   就重写。
3. **简单至上**：简单明了，不堆概念、不炫技；能一句话说清的不写三句。
4. **可读性优先于省字**：清晰第一；不为省字用损害清晰的简写——伪精炼让读者
   花时间重读，反而更费。
...
| 模式 | 例子 | 改法 |
|---|---|---|
| 怪异比喻 | 「按单办事、不加菜」 | 用平实表述：「按规定做，做完不留原始痕迹」 |
| 为省字牺牲清晰 | 简写到丢了意思 | 清晰展开，清晰第一 |
| 空洞口号排比 | 堆「赋能、抓手、闭环」这类词 | 说具体的事 |
| 抽象标签清单 | 罗列一串抽象标签 | 演成具体场景 |
| 过度修饰 | 一堆「可能/也许/或许」 | 直接给判断；不确定处明确标注 |

**好/坏例子**（最典型一对）：

- 坏：「按单办事、不加菜」（怪异比喻，读着费劲）
- 好：「按规定做，做完不留原始痕迹」（平实，一眼懂）

> 标准不是限制写作，是让任何人、任何 agent 接手文档都读得懂、改不坏。
<!-- /FACT -->
