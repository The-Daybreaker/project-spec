...
- （2026-09-05）与 software-dev 同步口径：场景声明收窄为「个人长期维护
  ...
  「缩放旋钮」更名「流程调节」，回溯明确为「纳入任务进行核查和调整」；
